<template>
	<view class="content">
		...
		<view class="imgcontent" :style="{ marginTop: imgContentTop}">
			...
			<view class="template">
				<image class="arrow_left" src="../../static/arrow-left-bold.png" @click="prevSwiper"></image>
				...
				<image class="arrow_right" src="../../static/arrow-right-bold.png" @click="nextSwiper"></image>
			</view>
		</view>
		
		<view class="gen-button" @click="genpic">
			<image src="/static/gen_button.png"></image>
		</view>
	</view>
</template>
	...
	export default {
		data() {
			return {
				...
				remoteUrl: '',
				bannerImgTop: '376rpx',
				imgContentTop: '180rpx',
			}
		},
		onLoad(option) {
			this.getGqTemplateList()
			// this.bannerImgTop = getHeight('376rpx')
			// this.imgContentTop = getHeight('180rpx')
		},
		methods: {
